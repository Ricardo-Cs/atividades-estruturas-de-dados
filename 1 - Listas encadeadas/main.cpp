...
int main(int argc, char* argv[]) {
    ...
    // Alocação dinamica para evitar estouro de memoria
        ...
        switch (opcao) {
            ...
            case 2: // Imprimir lista encadeada
                ...
                if (listaVazia(listaPessoas[num_lista]->pessoa)) {
                    printf("\n\nImpossível imprimir! A lista esta vazia!\n");
                } else {
    ...
    // Liberação de memoria antes de sair. Verifica se lista e NULL antes de liberar
